...
module.exports = {
    ...
    async createGrade(request, response) {
        ...
        const { student = "Roberto Achar ", subject = "03 - React", type ="Fórum", value ="10" } = request.body;
    ...
    async updateGrade(request, response) {
        const { id = "33", student, subject, type, value ="15" } = request.body;
        var fs = require("fs");
    ...
    async totalGrade(request, response) {
        var fs = require("fs");
        const { student ="Roberto Achar", subject ="03 - React" } = request.body;
    ...
    async avgGrade(request, response) {
        var fs = require("fs");
        const { subject = "04 - MongoDB", type = "Trabalho Prático" } = request.body;
    ...
    async avgTopThreeGrade(request, response) {
        ...
        const { subject = "03 - React” e type", type ="Trabalho Prático" } = request.body;
